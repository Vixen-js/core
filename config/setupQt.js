        ...
        components: [
          {
            ...
            skip: () =>
              fs.existsSync(path.resolve(qtHome, "bin", "Qt6Core.dll")),
          },
          {
            name: "Qt Svg",
            ...
            skip: () =>
              fs.existsSync(path.resolve(qtHome, "bin", "Qt6Svg.dll")),
          },
          {
            name: "Qt Tools",
            ...
            skip: () =>
              fs.existsSync(path.resolve(qtHome, "bin", "windeployqt.exe")),
          },
        ],
      };
    }
