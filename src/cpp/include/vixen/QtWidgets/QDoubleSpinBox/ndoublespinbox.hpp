...
class DLL_EXPORT NDoubleSpinBox : public QDoubleSpinBox, public NodeWidget
{
  ...
  public:
    ...
    virtual void connectSignalsToEventEmitter()
    {
        ...
        QObject::connect(this, QOverload<double>::of(&QDoubleSpinBox::valueChanged), [=](double val) {
            Napi::Env env = this->emitOnNode.Env();
            Napi::HandleScope scope(env);
            this->emitOnNode.Call({Napi::String::New(env, "onValueChange"), Napi::Number::New(env, val)});
        });
    }
};
