    ...
    virtual void connectSignalsToEventEmitter()
    {
        ...
        QObject::connect(this, &QLabel::linkActivated, [=](const QString &link) {
            ...
            this->emitOnNode.Call(
                {Napi::String::New(env, "onLinkActivate"), Napi::String::New(env, link.toStdString())});
        });
        QObject::connect(this, &QLabel::linkHovered, [=](const QString &link) {
            Napi::Env env = this->emitOnNode.Env();
            Napi::HandleScope scope(env);
            this->emitOnNode.Call({Napi::String::New(env, "onLinkHover"), Napi::String::New(env, link.toStdString())});
        });
    }
};
