...
Napi::Object QStyleWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(
        env, CLASSNAME,
        {InstanceMethod("pixelMetric", &QStyleWrap::pixelMetric), InstanceMethod("polish", &QStyleWrap::polish),
         InstanceMethod("unpolish", &QStyleWrap::unpolish), COMPONENT_WRAPPED_METHODS_EXPORT_DEFINE(QStyleWrap)});
    constructor = Napi::Persistent(func);
    exports.Set(CLASSNAME, func);
    return exports;
}

QStyleWrap::QStyleWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QStyleWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QStyleWrap: Incorrect initialization of QStyleWrap")
            .ThrowAsJavaScriptException();
    }
    this->rawData = extrautils::configureComponent(this->getInternalInstance());
}

QStyle *QStyleWrap::getInternalInstance()
{
