...
Napi::Object QActionWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(
        env, CLASSNAME,
        {InstanceMethod("setText", &QActionWrap::setText), InstanceMethod("setEnabled", &QActionWrap::setEnabled),
         InstanceMethod("setIcon", &QActionWrap::setIcon), InstanceMethod("setMenu", &QActionWrap::setMenu),
         ...
         InstanceMethod("isChecked", &QActionWrap::isChecked), InstanceMethod("setChecked", &QActionWrap::setChecked),
         InstanceMethod("isSeparator", &QActionWrap::isSeparator),
         InstanceMethod("setSeparator", &QActionWrap::setSeparator), InstanceMethod("setFont", &QActionWrap::setFont),
         InstanceMethod("data", &QActionWrap::data), InstanceMethod("setData", &QActionWrap::setData),
...
QAction *QActionWrap::getInternalInstance()
{
...
QActionWrap::QActionWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QActionWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QActionWrap: Wrong number of arguments to constructor")
