...
Napi::Object QDateTimeEditWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME, {QDATETIMEEDIT_WRAPPED_METHODS_EXPORT_DEFINE(QDateTimeEditWrap)});
...
QDateTimeEditWrap::QDateTimeEditWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QDateTimeEditWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QDateTimeEditWrap: Wrong number of arguments to constructor")
