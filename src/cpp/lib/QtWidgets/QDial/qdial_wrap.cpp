...
Napi::Object QDialWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME, {QABSTRACTSLIDER_WRAPPED_METHODS_EXPORT_DEFINE(QDialWrap)});
...
QDial *QDialWrap::getInternalInstance()
{
...
QDialWrap::QDialWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QDialWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QDialWrap: Wrong number of arguments to constructor")
