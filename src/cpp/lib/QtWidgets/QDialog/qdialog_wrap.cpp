...
Napi::Object QDialogWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME, {QDIALOG_WRAPPED_METHODS_EXPORT_DEFINE(QDialogWrap)});
...
QDialog *QDialogWrap::getInternalInstance()
{
...
QDialogWrap::QDialogWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QDialogWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QDialogWrap: Wrong number of arguments to constructor")
