...
QDoubleSpinBoxWrap::QDoubleSpinBoxWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QDoubleSpinBoxWrap>(info)
{
    ...
    else if (argCount == 1)
    {
        ...
        else
        {
            ...
            this->instance = new NDoubleSpinBox(parentWidgetWrap->getInternalInstance());
        }
    }
    else
    {
        Napi::TypeError::New(env, "Vixen: QDoubleSpinBoxWrap: Wrong number of arguments to constructor")
