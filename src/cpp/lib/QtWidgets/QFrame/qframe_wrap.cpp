...
Napi::Object QFrameWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME, {QFRAME_WRAPPED_METHODS_EXPORT_DEFINE(QFrameWrap)});
...
QFrame *QFrameWrap::getInternalInstance()
{
...
QFrameWrap::QFrameWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QFrameWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QFrameWrap: Wrong number of arguments to constructor")
