...
Napi::Object QGraphicsBlurEffectWrap::init(Napi::Env env, Napi::Object exports)
{
    Napi::HandleScope scope(env);
    char CLASSNAME[] = "QGraphicsBlurEffect";
    Napi::Function func =
        DefineClass(env, CLASSNAME, {QGRAPHICSEFFECT_WRAPPED_METHODS_EXPORT_DEFINE(QGraphicsBlurEffectWrap)});
    ...
    : Napi::ObjectWrap<QGraphicsBlurEffectWrap>(info)
{
    ...
    else if (argCount == 1)
    {
        ...
        else
        {
            ...
            this->instance = new NGraphicsBlurEffect(parentWidgetWrap->getInternalInstance());
        }
    }
    else
    {
        Napi::TypeError::New(env, "Vixen: QGraphicsBlurEffectWrap: Wrong number of "
