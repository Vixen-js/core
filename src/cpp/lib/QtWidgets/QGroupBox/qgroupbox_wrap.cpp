...
Napi::Object QGroupBoxWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME, {QWIDGET_WRAPPED_METHODS_EXPORT_DEFINE(QGroupBoxWrap)});
...
QGroupBox *QGroupBoxWrap::getInternalInstance()
{
    return this->instance;
}

QGroupBoxWrap::QGroupBoxWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QGroupBoxWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QGroupBoxWrap: Wrong number of arguments to constructor")
