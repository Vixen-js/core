...
QLCDNumber *QLCDNumberWrap::getInternalInstance()
{
...
QLCDNumberWrap::QLCDNumberWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QLCDNumberWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QLCDNumberWrap: Wrong number of arguments to constructor")
