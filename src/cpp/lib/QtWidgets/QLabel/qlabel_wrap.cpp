...
Napi::Object QLabelWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(
        ...
        {InstanceMethod("setSelection", &QLabelWrap::setSelection),
         ...
         InstanceMethod("setBuddy", &QLabelWrap::setBuddy), InstanceMethod("buddy", &QLabelWrap::buddy),
         InstanceMethod("clear", &QLabelWrap::clear), InstanceMethod("setMovie", &QLabelWrap::setMovie),
         InstanceMethod("setNumDouble", &QLabelWrap::setNumDouble), InstanceMethod("setNumInt", &QLabelWrap::setNumInt),
         InstanceMethod("setPicture", &QLabelWrap::setPicture), InstanceMethod("setPixmap", &QLabelWrap::setPixmap),
...
QLabelWrap::QLabelWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QLabelWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QLabelWrap: Wrong number of arguments to constructor")
            .ThrowAsJavaScriptException();
    }

    YogaWidget *yogaWidget = dynamic_cast<YogaWidget *>(this->getInternalInstance());
    if (yogaWidget)
    {
...
Napi::Value QLabelWrap::setBuddy(const Napi::CallbackInfo &info)
{
    ...
    NodeWidgetWrap *buddyWrap = Napi::ObjectWrap<NodeWidgetWrap>::Unwrap(buddyObject);
...
Napi::Value QLabelWrap::setPicture(const Napi::CallbackInfo &info)
{
    ...
    QPictureWrap *pictureWrap = Napi::ObjectWrap<QPictureWrap>::Unwrap(pictureObject);
