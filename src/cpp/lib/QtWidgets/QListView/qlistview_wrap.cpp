...
Napi::Object QListViewWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME, {QLISTVIEW_WRAPPED_METHODS_EXPORT_DEFINE(QListViewWrap)});
...
QListView *QListViewWrap::getInternalInstance()
{
...
QListViewWrap::QListViewWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QListViewWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QListViewWrap: Wrong number of arguments to constructor")
