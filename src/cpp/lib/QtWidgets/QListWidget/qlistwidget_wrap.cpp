...
Napi::Object QListWidgetWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(
        ...
        {InstanceMethod("addItem", &QListWidgetWrap::addItem),
         ...
         InstanceMethod("isPersistentEditorOpen_QModelIndex", &QListWidgetWrap::isPersistentEditorOpen_QListWidgetItem),
         ...
         InstanceMethod("openPersistentEditor_QListWidgetItem", &QListWidgetWrap::openPersistentEditor_QListWidgetItem),
...
QListWidget *QListWidgetWrap::getInternalInstance()
{
...
QListWidgetWrap::QListWidgetWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QListWidgetWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QListWidgetWrap: Wrong number of arguments to constructor")
...
Napi::Value QListWidgetWrap::addItem(const Napi::CallbackInfo &info)
{
    ...
    QListWidgetItemWrap *itemWrap = Napi::ObjectWrap<QListWidgetItemWrap>::Unwrap(itemObject);
...
Napi::Value QListWidgetWrap::closePersistentEditor_QListWidgetItem(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
    Napi::Object itemObject = info[0].As<Napi::Object>();
    QListWidgetItemWrap *itemWrap = Napi::ObjectWrap<QListWidgetItemWrap>::Unwrap(itemObject);
...
Napi::Value QListWidgetWrap::findItems(const Napi::CallbackInfo &info)
{
    ...
    QList<QListWidgetItem *> items = this->instance->findItems(text, static_cast<Qt::MatchFlags>(flags));
...
Napi::Value QListWidgetWrap::isPersistentEditorOpen_QListWidgetItem(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
    Napi::Object itemObject = info[0].As<Napi::Object>();
    QListWidgetItemWrap *itemWrap = Napi::ObjectWrap<QListWidgetItemWrap>::Unwrap(itemObject);
...
Napi::Value QListWidgetWrap::openPersistentEditor_QListWidgetItem(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
    Napi::Object itemObject = info[0].As<Napi::Object>();
    QListWidgetItemWrap *itemWrap = Napi::ObjectWrap<QListWidgetItemWrap>::Unwrap(itemObject);
...
Napi::Value QListWidgetWrap::setItemWidget(const Napi::CallbackInfo &info)
{
    ...
    this->instance->setItemWidget(itemWrap->getInternalInstance(), widgetWrap->getInternalInstance());
    return env.Null();
}
...
Napi::Value QListWidgetWrap::scrollToItem(const Napi::CallbackInfo &info)
{
    ...
    this->instance->scrollToItem(itemWrap->getInternalInstance(), static_cast<QAbstractItemView::ScrollHint>(hint));
    return env.Null();
}
