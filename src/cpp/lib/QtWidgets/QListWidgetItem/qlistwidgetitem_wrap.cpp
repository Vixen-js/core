...
Napi::Object QListWidgetItemWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME,
                                      {InstanceMethod("setBackground", &QListWidgetItemWrap::setBackground),
                                       ...
                                       InstanceMethod("setTextAlignment", &QListWidgetItemWrap::setTextAlignment),
...
QListWidgetItemWrap::QListWidgetItemWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QListWidgetItemWrap>(info)
{
    ...
    else
    {
        ...
        if (argCount == 1)
        {
            QString text = QString::fromUtf8(info[0].As<Napi::String>().Utf8Value().c_str());
        ...
        {
            Napi::TypeError::New(env, "Vixen: QListWidgetItemWrap: Wrong number of arguments")
...
Napi::Value QListWidgetItemWrap::background(const Napi::CallbackInfo &info)
{
    ...
    auto instance = QBrushWrap::constructor.New({Napi::External<QBrush>::New(env, new QBrush(brush))});
    return instance;
}
...
Napi::Value QListWidgetItemWrap::setData(const Napi::CallbackInfo &info)
{
    ...
    QVariantWrap *variantWrap = Napi::ObjectWrap<QVariantWrap>::Unwrap(variantObject);
...
Napi::Value QListWidgetItemWrap::data(const Napi::CallbackInfo &info)
{
    ...
    auto instance = QVariantWrap::constructor.New({Napi::External<QVariant>::New(env, new QVariant(data))});
    return instance;
}
...
Napi::Value QListWidgetItemWrap::font(const Napi::CallbackInfo &info)
{
    ...
    auto instance = QFontWrap::constructor.New({Napi::External<QFont>::New(env, new QFont(font))});
    return instance;
}
...
Napi::Value QListWidgetItemWrap::setTextAlignment(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
