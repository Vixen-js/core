...
Napi::Object QProgressDialogWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME,
                                      {InstanceMethod("cancel", &QProgressDialogWrap::cancel),
                                       ...
                                       InstanceMethod("setCancelButtonText", &QProgressDialogWrap::setCancelButtonText),
...
QProgressDialogWrap::QProgressDialogWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QProgressDialogWrap>(info)
{
    ...
    else if (argCount == 1)
    {
        ...
        else
        {
            ...
            this->instance = new NProgressDialog(parentWidgetWrap->getInternalInstance());
        }
    }
    else
    {
        Napi::TypeError::New(env, "Vixen: QProgressDialogWrap: Wrong number of "
...
Napi::Value QProgressDialogWrap::setCancelButtonText(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
