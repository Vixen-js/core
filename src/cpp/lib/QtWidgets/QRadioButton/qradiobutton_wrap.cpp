...
Napi::Object QRadioButtonWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func =
        DefineClass(env, CLASSNAME, {QABSTRACTBUTTON_WRAPPED_METHODS_EXPORT_DEFINE(QRadioButtonWrap)});
...
QRadioButtonWrap::QRadioButtonWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QRadioButtonWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QRadioButtonWrap: Wrong number of arguments to constructor")
