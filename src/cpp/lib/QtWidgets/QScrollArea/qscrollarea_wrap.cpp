...
Napi::Object QScrollAreaWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME, {QSCROLLAREA_WRAPPED_METHODS_EXPORT_DEFINE(QScrollAreaWrap)});
...
QScrollArea *QScrollAreaWrap::getInternalInstance()
{
...
QScrollAreaWrap::QScrollAreaWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QScrollAreaWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QScrollAreaWrap: Wrong number of arguments to constructor")
