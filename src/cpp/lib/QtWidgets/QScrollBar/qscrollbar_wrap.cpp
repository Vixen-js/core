...
Napi::Object QScrollBarWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME, {QABSTRACTSLIDER_WRAPPED_METHODS_EXPORT_DEFINE(QScrollBarWrap)});
...
QScrollBar *QScrollBarWrap::getInternalInstance()
{
    return this->instance;
}

QScrollBarWrap::QScrollBarWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QScrollBarWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QScrollBarWrap: Wrong number of arguments to constructor")
