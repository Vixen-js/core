...
Napi::Object QSplitterWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME, {QSPLITTER_WRAPPED_METHODS_EXPORT_DEFINE(QSplitterWrap)});
...
QSplitter *QSplitterWrap::getInternalInstance()
{
...
QSplitterWrap::QSplitterWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QSplitterWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QSplitterWrap: Wrong number of arguments to constructor")
