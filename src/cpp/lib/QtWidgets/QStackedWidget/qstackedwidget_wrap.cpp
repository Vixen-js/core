...
QStackedWidgetWrap::QStackedWidgetWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QStackedWidgetWrap>(info)
{
    ...
    else if (argCount == 1)
    {
        ...
        else
        {
            ...
            this->instance = new NStackedWidget(parentWidgetWrap->getInternalInstance());
        }
    }
    else
    {
        Napi::TypeError::New(env, "Vixen: QStackedWidgetWrap: Wrong number of arguments to constructor")
