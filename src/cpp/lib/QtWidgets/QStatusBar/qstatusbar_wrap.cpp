...
Napi::Object QStatusBarWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME,
                                      {InstanceMethod("addPermanentWidget", &QStatusBarWrap::addPermanentWidget),
                                       ...
                                       InstanceMethod("insertPermanentWidget", &QStatusBarWrap::insertPermanentWidget),
                                       ...
                                       InstanceMethod("setSizeGripEnabled", &QStatusBarWrap::setSizeGripEnabled),
...
QStatusBar *QStatusBarWrap::getInternalInstance()
{
    return this->instance;
}

Napi::Value QStatusBarWrap::fromQStatusBar(Napi::Env env, QStatusBar *statusBar)
{
    ...
    return QStatusBarWrap::constructor.New(
        {Napi::External<QStatusBar>::New(env, statusBar), Napi::Boolean::New(env, true)});
}
...
QStatusBarWrap::QStatusBarWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QStatusBarWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QStatusBarWrap: Wrong number of arguments to constructor")
...
Napi::Value QStatusBarWrap::addPermanentWidget(const Napi::CallbackInfo &info)
{
    ...
    NodeWidgetWrap *widgetWrap = Napi::ObjectWrap<NodeWidgetWrap>::Unwrap(widgetArg);
...
Napi::Value QStatusBarWrap::insertPermanentWidget(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
    ...
    int targetIndex = this->instance->insertPermanentWidget(index, widget, stretch);
