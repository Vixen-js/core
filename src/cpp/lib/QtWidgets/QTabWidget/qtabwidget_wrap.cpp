...
Napi::Object QTabWidgetWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(
        env, CLASSNAME,
        {InstanceMethod("addTab_3", &QTabWidgetWrap::addTab_3), InstanceMethod("addTab_2", &QTabWidgetWrap::addTab_2),
         ...
         InstanceMethod("indexOf", &QTabWidgetWrap::indexOf), InstanceMethod("setTabText", &QTabWidgetWrap::setTabText),
         ...
         InstanceMethod("widget", &QTabWidgetWrap::widget), QWIDGET_WRAPPED_METHODS_EXPORT_DEFINE(QTabWidgetWrap)});
...
QTabWidget *QTabWidgetWrap::getInternalInstance()
{
...
QTabWidgetWrap::QTabWidgetWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QTabWidgetWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QTabWidgetWrap: Wrong number of arguments to constructor")
...
Napi::Value QTabWidgetWrap::addTab_3(const Napi::CallbackInfo &info)
{
    ...
    NodeWidgetWrap *pageObjectWrap = Napi::ObjectWrap<NodeWidgetWrap>::Unwrap(pageObject);
...
Napi::Value QTabWidgetWrap::addTab_2(const Napi::CallbackInfo &info)
{
    ...
    int index = this->instance->addTab(pageObjectWrap->getInternalInstance(), label.c_str());
    return Napi::Number::New(env, index);
}
...
Napi::Value QTabWidgetWrap::insertTab_4(const Napi::CallbackInfo &info)
{
    ...
    int index = this->instance->insertTab(tabPosition, pageObjectWrap->getInternalInstance(),
...
Napi::Value QTabWidgetWrap::indexOf(const Napi::CallbackInfo &info)
{
    ...
    NodeWidgetWrap *widgetObjectWrap = Napi::ObjectWrap<NodeWidgetWrap>::Unwrap(widgetObject);
