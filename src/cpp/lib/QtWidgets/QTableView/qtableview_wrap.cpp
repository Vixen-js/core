...
Napi::Object QTableViewWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME, {QTABLEVIEW_WRAPPED_METHODS_EXPORT_DEFINE(QTableViewWrap)});
...
QTableView *QTableViewWrap::getInternalInstance()
{
...
QTableViewWrap::QTableViewWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QTableViewWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QTableViewWrap: Wrong number of arguments to constructor")
