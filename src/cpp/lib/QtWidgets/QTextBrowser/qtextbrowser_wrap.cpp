...
Napi::Object QTextBrowserWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(
        env, CLASSNAME,
        {InstanceMethod("backwardHistoryCount", &QTextBrowserWrap::backwardHistoryCount),
         InstanceMethod("clearHistory", &QTextBrowserWrap::clearHistory),
         InstanceMethod("forwardHistoryCount", &QTextBrowserWrap::forwardHistoryCount),
         InstanceMethod("historyTitle", &QTextBrowserWrap::historyTitle),
         InstanceMethod("historyUrl", &QTextBrowserWrap::historyUrl),
         InstanceMethod("isBackwardAvailable", &QTextBrowserWrap::isBackwardAvailable),
         InstanceMethod("isForwardAvailable", &QTextBrowserWrap::isForwardAvailable),
         InstanceMethod("backward", &QTextBrowserWrap::backward), InstanceMethod("forward", &QTextBrowserWrap::forward),
         InstanceMethod("home", &QTextBrowserWrap::home), InstanceMethod("reload", &QTextBrowserWrap::reload),
...
QTextBrowser *QTextBrowserWrap::getInternalInstance()
{
    return this->instance;
}

QTextBrowserWrap::QTextBrowserWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QTextBrowserWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QTextBrowserWrap: Wrong number of arguments to constructor")
...
Napi::Value QTextBrowserWrap::backwardHistoryCount(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
...
Napi::Value QTextBrowserWrap::forwardHistoryCount(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
...
Napi::Value QTextBrowserWrap::isBackwardAvailable(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
    return Napi::Boolean::New(env, this->instance->isBackwardAvailable());
}

Napi::Value QTextBrowserWrap::isForwardAvailable(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
