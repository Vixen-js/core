...
Napi::Object QTextEditWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME, {QTEXTEDIT_WRAPPED_METHODS_EXPORT_DEFINE(QTextEditWrap)});
...
QTextEdit *QTextEditWrap::getInternalInstance()
{
    return this->instance;
}

QTextEditWrap::QTextEditWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QTextEditWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QTextEditWrap: Wrong number of arguments to constructor")
