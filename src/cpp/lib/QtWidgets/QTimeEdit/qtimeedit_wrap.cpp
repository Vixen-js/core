...
Napi::Object QTimeEditWrap::init(Napi::Env env, Napi::Object exports)
{
    ...
    Napi::Function func = DefineClass(env, CLASSNAME, {QDATETIMEEDIT_WRAPPED_METHODS_EXPORT_DEFINE(QTimeEditWrap)});
...
QTimeEdit *QTimeEditWrap::getInternalInstance()
{
    return this->instance;
}

QTimeEditWrap::QTimeEditWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QTimeEditWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QTimeEditWrap: Wrong number of arguments to constructor")
