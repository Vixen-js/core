...
QToolButton *QToolButtonWrap::getInternalInstance()
{
...
QToolButtonWrap::QToolButtonWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<QToolButtonWrap>(info)
{
    ...
    {
        Napi::TypeError::New(env, "Vixen: QToolButtonWrap: Wrong number of arguments to constructor")
