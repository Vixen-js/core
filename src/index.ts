...
export {
  QTableWidget,
  QTableWidgetSignals,
} from "./lib/QtWidgets/QTableWidget";
...
export {
  ...
  QMessageBoxIcon,
  ButtonRole,
} from "./lib/QtWidgets/QMessageBox";
export {
  QInputDialog,
  QInputDialogSignals,
  InputDialogOptions,
  InputMode,
} from "./lib/QtWidgets/QInputDialog";
...
export {
  QButtonGroup,
  QButtonGroupSignals,
} from "./lib/QtWidgets/QButtonGroup";
...
} from "./lib/QtWidgets/QStandardItemModel";
export { QStandardItem } from "./lib/QtWidgets/QStandardItem";
export {
  QTextBrowser,
  QTextBrowserSignals,
} from "./lib/QtWidgets/QTextBrowser";
export {
  QTextEdit,
  QTextEditSignals,
  AutoFormattingFlag,
...
export {
  QItemSelectionModel,
  SelectionFlag,
} from "./lib/QtCore/QItemSelectionModel";
