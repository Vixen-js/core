  ...
  constructor() {
    ...
    const dispatcher = (methodName: string, ...args: any[]): any => {
      switch (methodName) {
        case "index":
          try {
            return this.index(args[0], args[1], new QModelIndex(args[2]))
              .native;
          } catch (e) {
            console.log(
              `An exception was thrown while dispatching to method 'index':`
            );
            console.log(e);
          }
        ...
        case "parent":
          try {
            ...
            console.log(
              `An exception was thrown while dispatching to method 'parentModelIndex':`
            );
            console.log(e);
          }
          return new QModelIndex().native;
        ...
        case "rowCount":
          try {
            ...
            console.log(
              `An exception was thrown while dispatching to method 'rowCount':`
            );
            console.log(e);
          }
          return 0;
        ...
        case "columnCount":
          try {
            ...
            console.log(
              `An exception was thrown while dispatching to method 'columnCount':`
            );
            console.log(e);
          }
          return 0;
        ...
        case "data":
          try {
            ...
            console.log(
              `An exception was thrown while dispatching to method 'data':`
            );
            console.log(e);
          }
        ...
        case "flags":
          try {
            ...
            console.log(
              `An exception was thrown while dispatching to method 'flags':`
            );
            console.log(e);
          }
        ...
        case "headerData":
          try {
            ...
            console.log(
              `An exception was thrown while dispatching to method 'headerData':`
            );
            console.log(e);
          }
          return new QVariant().native;
        ...
        case "setData":
          try {
            return this.setData(
              new QModelIndex(args[0]),
              new QVariant(args[1]),
              args[2]
            );
          } catch (e) {
            console.log(
              `An exception was thrown while dispatching to method 'setData':`
            );
            console.log(e);
          }
          return false;
        ...
        case "buddy":
          try {
            ...
            console.log(
              `An exception was thrown while dispatching to method 'buddy':`
            );
            console.log(e);
          }
          return new QModelIndex().native;
