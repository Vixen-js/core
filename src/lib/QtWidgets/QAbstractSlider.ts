...
QAbstractSlider will list all methods and properties that are common to all slider widgets in the Vixen world.

 */
export abstract class QAbstractSlider<
  Signals extends QAbstractSliderSignals
> extends QWidget<Signals> {
