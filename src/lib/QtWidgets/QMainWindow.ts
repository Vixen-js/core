...
A `QMainWindow` provides a main application window. Every widget in Vixen should be a child/nested child of QMainWindow. QMainWindow in Vixen is also responsible for FlexLayout calculations of its children.

### Example

```javascript
import { QMainWindow, QWidget } from "@vixen-js/core";
