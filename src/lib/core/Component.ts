...
> Abstract class that is root most base class for all widgets and layouts in the Vixen World.

**This class is used to add core properties to all widgets, layouts etc in Vixen world.
...
Its the root base class in Vixen world.
